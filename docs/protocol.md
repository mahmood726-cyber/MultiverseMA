        # Multiversema: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/MultiverseMA.git

        ## Objective

        MultiverseMA implements multiverse meta-analysis, systematically exploring all reasonable analytical choices to characterise the robustness and researcher-degree-of-freedom sensitivity of pooled estimates.
        ...
        - Code: https://github.com/mahmood726-cyber/MultiverseMA.git
        - Dashboard: https://mahmood726-cyber.github.io/MultiverseMA/
